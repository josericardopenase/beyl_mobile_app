...
import { ADDED_TRAINER } from '../../../../events/events'
...
export default function JoinTrainer() {
    ...
    const joinTrainer = async () => {
        ...
        const result = await apiInvitationKey.joinTrainer(information.key);
		...
		EventBus.publish(ADDED_TRAINER, information.trainer);
        setSuccess(true)
    ...
    return (
        <View style={{padding: 10, flex: 1}}>
                    <Title1 style={{marginTop: 30}}><Bold>Introduce</Bold> tu código de entrenador</Title1>
                                ...
                                <View style={styles.modalView}>
                                    {
                                        ...
                                        <>
                                            ...
                                            <TouchableOpacity onPress={() => joinTrainer()}>
                                        ...
                                        <>
                                            <View style={{alignItems: "center"}}>
                                                <Title3 primary={true} primary={false}>Felicidades</Title3>
                                                <Text style={{color: PalleteColors.textPrimaryColor, fontSize: 22, textAlign: "center"}}><Bold>Te has unido correctamente</Bold></Text>

                                            </View>
                                            <Ionicons name={"ios-checkmark-circle-outline"} color={"#49AF40"} size={148} style={{alignSelf: "center"}}></Ionicons>
                                            <TouchableOpacity onPress={() => navigation.navigate("Profile")} style={{marginTop: 10}}>
                                                <FormButton placeholder="Genial" background="#49AF40"></FormButton>
                                            </TouchableOpacity>
