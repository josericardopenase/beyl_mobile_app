...
export default function FormDateTimePicker2({name, placeholder, mode, first}) {
      ...
      <View>
        <TouchableOpacity onPress={showIt} style={{
            ...
            <View style={{flexDirection: "row", alignItems: "center"}}>
              <MaterialCommunityIcons name="calendar" style={{marginRight: 10}} color={PalleteColors.textSecondaryColor} size={20}></MaterialCommunityIcons>
              <Title5 primary={true}>{placeholder}</Title5>
            </View>
