...
export default function ErrorNothing({error}) {
    return (
        <View style={{flex: 1, justifyContent: "center", alignContent: "center", alignItems: "center", flexDirection: "column", padding: 10}}>
            <Image source={require('../../../assets/errorNotFound.png')} style={{width: '70%', resizeMode: "contain", height: 220, marginBottom: 20}}/>
            <Title2><Bold>Oh no!</Bold></Title2> 
